...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventContainer.hide_children'
        db.add_column('events_eventcontainer', 'hide_children',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventContainer.hide_children'
        db.delete_column('events_eventcontainer', 'hide_children')
