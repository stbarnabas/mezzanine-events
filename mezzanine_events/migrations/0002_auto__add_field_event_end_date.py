...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'mezzanine_events_event', 'end_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 3, 9, 0, 0)),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Event.end_date'
        db.delete_column(u'mezzanine_events_event', 'end_date')
